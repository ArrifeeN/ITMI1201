...
@section('content')
    ...
    <div class="mb-2">
        {{-- <h3 class="float-end">{{ Auth::users()->name }}</h3> --}}
    </div>
    <div class="mb-2">
        <a href="{{ url('/login')}}" role="button" class="btn btn-sm btn-warning float-end">Logout</a>
    </div>
    <div class="mb-2">
        <a href="{{ url('content/create') }}" role="button" class="btn btn-sm btn-success">Create Content</a>
        <a href="{{ url('/')}}" role="buton" class="btn btn-sm btn-primary">Main Menu</a>
    </div>
